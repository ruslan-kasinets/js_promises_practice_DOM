...
const firstPromise = new Promise((resolve, reject)=>{
    const timerId = setTimeout(()=>reject(new Error("First promise was rejected")), 3000);
...
const errorHandler = (errorText)=>createMessage(errorText instanceof Error ? errorText.message : String(errorText), true);
